            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <a href="{{ route('bai1.create') }}"><button type="button" class="btn btn-info add-new"><i class="fa fa-plus"></i> Add New</button></a>
                        </div>
                    </div>
                    @if(session('success'))
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('bai1.edit', $item->sale_id) }}" class="edit" title="Edit">
                                    <button type="button">Edit</button>
                                </a>
                                <form action="{{ route('bai1.destroy', $item->sale_id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
