                    ...
                    <tbody>
                        ...
                        ?>
                            <tr data-index="<?= $value['id'] ?>">
                                ...
                                <td><img src="<?= htmlspecialchars($value['img']) ?>" alt="<?= htmlspecialchars($value['name']) ?>" class="flower-image">
                                <td>
                                    <a href="edit.php?index=<?= $value['id'] ?>&name=<?= urlencode($value['name']) ?>&description=<?= urlencode($value['description']) ?>&image=<?= urlencode($value['img']) ?>" class="edit" title="Edit" data-toggle="tooltip"><i class="fa-solid fa-pen-to-square"></i></a>
                                    <form action="deleteProcess.php" method="POST" style="display: inline-block;">
